"""Enterprise security boundary for visual-dashboard routes."""
...
from datus.api.models.downstream import DashboardEditSession
from datus.api.routes import dashboard_routes as upstream_dashboard_routes
...
async def get_dashboard_detail(
    ...
    return await upstream_dashboard_routes.get_dashboard_detail(svc, slug)
...
async def create_dashboard_edit_session(
    ...
    svc = await _resolve_request_service(request)
    detail = await upstream_dashboard_routes.get_dashboard_detail(svc, slug)
