...
class TestCreateParser:
    ...
    def test_migrate_success_stories_action_parsed(self):
        parser = create_parser()
        args = parser.parse_args(
            [
...
class TestMainMigrateSuccessStoriesAction:
    def test_migration_runs_before_agent_initialization(self):
    ...
    def test_migration_os_error_returns_one_without_agent_initialization(self):
        mock_config = MagicMock(project_name="demo")
        mock_service = MagicMock()
