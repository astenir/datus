...
import pytest
from datus_hive import HiveConnector
...
@pytest.mark.integration
def test_tpch_get_columns(tpch_setup: HiveConnector):
...
@pytest.mark.integration
def test_tpch_get_columns_nation(tpch_setup: HiveConnector):
...
def test_tpch_query_region(tpch_setup: HiveConnector):
...
@pytest.mark.integration
@pytest.mark.acceptance
def test_tpch_query_nation(tpch_setup: HiveConnector):
...
@pytest.mark.integration
def test_tpch_query_join(tpch_setup: HiveConnector):
...
@pytest.mark.integration
def test_tpch_query_aggregation(tpch_setup: HiveConnector):
...
@pytest.mark.integration
def test_tpch_query_customer_orders(tpch_setup: HiveConnector):
...
@pytest.mark.integration
def test_tpch_query_csv_format(tpch_setup: HiveConnector):
