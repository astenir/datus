...
const modulePermissionLabels: Array<Omit<PermissionBadgeItem, "kind">> = [
  ...
  { code: "mcp.server.list", label: "MCP Server 查看" },
  { code: "mcp.server.add", label: "MCP Server 新增" },
  { code: "mcp.server.edit", label: "MCP Server 编辑" },
  { code: "mcp.server.remove", label: "MCP Server 删除" },
  { code: "mcp.server.connectivity", label: "MCP Server 连接检查" },
  { code: "mcp.server.tools", label: "MCP Server 工具查看" },
