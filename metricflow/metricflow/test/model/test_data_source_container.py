...
def test_elements_for_metric(new_metric_semantics: MetricSemantics) -> None:  # noqa: D
    assert set(
        ...
        "create_a_cycle_in_the_join_graph__listing__user__company",
        "create_a_cycle_in_the_join_graph__listing__user__company_name",
        "create_a_cycle_in_the_join_graph__listing__user__created_at",
        "create_a_cycle_in_the_join_graph__listing__user__ds_partitioned",
        "create_a_cycle_in_the_join_graph__listing__user__home_state",
        "create_a_cycle_in_the_join_graph__listing__user__home_state_latest",
